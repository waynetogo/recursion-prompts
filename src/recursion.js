...
var compareStr = function(str1, str2) {
  if ((str1 === '' && str2 === '') || (str1.length === 1 && str2.length === 1 && str1 === str2)) {
    return true;
  } else {
    if (str1[0] !== str2[0]) {
      return false;
...
var createArray = function(str) {
  ...
  return [str[0]].concat(createArray(result));
};
...
var rMap = function(array, callback) {
  ...
  var result = rMap(array.slice(1, array.length), callback);
...
var countKeysInObj = function(obj, key) {
  ...
  for (var property in obj) {
    ...
    if (typeof obj[property] === 'object') {
      counter += countKeysInObj(obj[property], key);
    }
  }
  return counter;
};
...
var countValuesInObj = function(obj, value) {
  ...
  for (var property in obj) {
    ...
    if (typeof obj[property] === 'object') {
      counter += countValuesInObj(obj[property], value);
    }
  }
  return counter;
};
...
var capitalizeWords = function(array) {
  ...
  result = capitalizeWords(array.slice(1));
...
var capitalizeFirst = function(array) {
  ...
  result = capitalizeFirst(array.slice(1));
  result.unshift(array[0].charAt(0).toUpperCase() + array[0].substring(1));
  return result;
};
...
var minimizeZeroes = function(array) {
  ...
  if (array[0] !== 0 || ((array[0] === 0 || result[0] === 0) && !(array[0] === 0 && result[0] === 0))) {
    result.unshift(array[0]);
  }
  return result;
...
var numToText = function(str) {
  ...
  if (str.length > 1) {
    return value + numToText(str.slice(1));
  } else {
    return value;
  }
};
